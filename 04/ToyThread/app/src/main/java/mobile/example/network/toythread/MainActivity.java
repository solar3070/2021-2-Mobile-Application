...
//                쓰레드 생성 후 실행
            ...
            case R.id.button2:
                ...
                // 스레드가 InterruptedException이 발생하면서 멈춤
                // 널 포인트 익셉션이 나지 않도록 주의를 기울이자
                break;
            case R.id.button3:
...
//            Message 에 실행 결과 저장
            ...
            // Integer는 이미 Serializable로 이미 구현이 되어 있는 클래스의 객체라 상관 없음
            // 직접 만들었을 때는 반드시 Serializable 인터페이스를 구현한 객체여야 함
